...
plot(y=E3, x= F4, xlab="fitted values", ylab= "Residuals")
plot(data_wkdf_new$IncNum, y = E3, xlab= "IncNum", ylab=MyYlab)
plot(E3 ~ data_wkdf_new$Yr.Inc.Form, xlab="Yr Inc Form", ylab="Residuals")
plot(data_wkdf_new$IncW_trans, E3, xlab="IncWtrans", ylab="Residuals")
plot(data_wkdf_new$Vwind_zc, E3, xlab="Vwinds", yab= "Residuals")
par(op)
