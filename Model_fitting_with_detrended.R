...
plot(data_wkdf$Detrended ~ data_wkdf$MSLA)
plot(data_wkdf$Detrended ~ data_wkdf$Vwind)
plot(data_wkdf$Detrended ~ data_wkdf$Uwind)
plot(data_wkdf$Detrended ~ data_wkdf$Av.Dis)
