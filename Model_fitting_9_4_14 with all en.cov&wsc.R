...
# #            Model df       AIC       BIC   logLik   Test   L.Ratio p-value
# Mfull2.lme     1 10 -3099.509 -3054.894 1559.755                         
# M1.A           2  9 -3100.731 -3060.577 1559.365 1 vs 2 0.7784575  0.3776
...
anova(Mfull2.lme, M1.B)
           ...
           # Model df       AIC       BIC   logLik   Test   L.Ratio p-value
# Mfull2.lme     1 10 -3099.509 -3054.894 1559.755                         
# M1.B           2  9 -3101.274 -3061.121 1559.637 1 vs 2 0.2345106  0.6282

anova(Mfull2.lme, M1.C)

           # Model df       AIC       BIC   logLik   Test  L.Ratio p-value
# Mfull2.lme     1 10 -3099.509 -3054.894 1559.755                        
# M1.C           2  9 -3077.184 -3037.031 1547.592 1 vs 2 24.32455  <.0001

anova(Mfull2.lme, M1.D)

           # Model df       AIC       BIC   logLik   Test     L.Ratio p-value
# Mfull2.lme     1 10 -3099.509 -3054.894 1559.755                           
# M1.D           2  9 -3101.508 -3061.354 1559.754 1 vs 2 0.001443409  0.9697
