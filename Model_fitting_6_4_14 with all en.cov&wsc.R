...
data= read.csv("BC_6_3_14.csv", header=TRUE)
...
#### INCLUDING WSC into model from Dons computed wind stress curl data

lat_lon <- read.csv("Lat_longs.csv", header=TRUE)

Stations <- lat_lon$Station

wsc_2006_07 <- read.table("station_wsc_200607.txt")
