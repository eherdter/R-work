...
YearLabel2011 <- data.frame(rep(2011, 998))
colnames(YearLabel2011) <- c("Year")
YearLabel2012<- data.frame(rep(2012, 996))
colnames(YearLabel2012) <- c("Year")
YearLabel2013 <- data.frame(rep(2013,996)) # for some reason this ran only 997 times unlike the two ones above that ran 999
...
boxplotLinf <- ggplot(working_Linf, aes(x=as.factor(Year), y=Linf, colour=as.factor(Year)))+
				 ...
				 ggtitle("Bootstrapped L∞ Estimations")
...
YearLabel2012<- data.frame(rep(2012, 996))
colnames(YearLabel2012) <- c("Year")
YearLabel2013 <- data.frame(rep(2013,996))
colnames(YearLabel2013) <- c("Year")
