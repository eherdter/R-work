...
anova(Mfull2.lme, M1.E)
           Model df       AIC       BIC   logLik   Test  L.Ratio p-value
Mfull2.lme     1  9 -2688.448 -2648.295 1353.224                        
M1.E           2  8 -2688.356 -2652.665 1352.178 1 vs 2 2.092007  0.1481
...
Mfinal <- lme(IncW_trans ~ IncNum + Yr.Inc.Form + Vwind, random=~1|Fish, method="REML", data=data_wkdf_sm, na.action=na.omit)
